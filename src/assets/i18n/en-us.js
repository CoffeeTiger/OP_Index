module.exports = {
  page: {
    ...
    faqBTitle5: 'What is OPH?',
    faqBContant5: 'OPH is an equity token issued by OpenPublish with a total mint of 200 million coins. OPH has two important characteristics: First, the value of OPH is backed by treasury assets, and the price coordination mechanism of OPH ensures that its value is not less than IV (intrinsic value). Second, as NFTs publishing transactions continue to capture value, OPH \' s IV continues to grow cumulatively.',

    faqBTitle1: 'What is the value of Open Publish?',
    faqBContant1: 'OpenPublish is committed to building a well-established triangular positive excitation system. Relying on a policy-controlled monetary system, effective incentives, and a new NFT business model, we can simultaneously promote:NFT value, platform trading revenue and OPH value growth.Don\'t miss the unexpected lucky opportunity of the raffle.We have reason to believe that this economic system can continue to optimize and develop and create wealth.',
    faqBContant2: '',

    faqCTitle1: 'Can only be profitable from publishing?',
    faqCContant1: 'Of course not, there are many ways to get paid in OpenPublish1, publishing NFTs',
    faqCContant2: 'copy sold will have sales revenue',
    faqCContant3: 'buying NFT publications (chance to win mystery prizes!).',
    faqCContant4: 'transaction rewards (more transactions, more rewards)',
    faqCContant5: 'pledge rewards (more pledges, more rewards)',
    faqCContant6: 'bonds (to get the opportunity to buy OPH at a discounted price)',
    faqCContant7: 'loans (expected OPH value to rise or fall arbitrage)',
    faqCContant8: 'community tasks (OPH rewards).',

    faqDTitle1: 'What are the rewards for OpenPublish?',
    faqDContant1: 'The rewards for OpenPublish consist of three parts',
    faqDContant2: 'Transaction Rewards:   Both buyers and sellers who trade NFTs  in OpenPublish can receive OPH rewards. ',
    faqDContant3: 'Pledge Rewards: You can also get rewards for staking your OPH or LPToken in OpenPublish .',
    faqDContant4: 'Community Quest Rewards: Claim quests in the OpenPublish community and receive rewards upon completion.',
